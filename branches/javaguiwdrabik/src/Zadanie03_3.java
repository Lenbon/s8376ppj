 ...
 * (max.   4p)
 * 
 * Zdefinuj w programie klasę abstrakcyjną Figura reprezentujacą dowolną figurę geometryczną:
 * 
 ...
 * }//class Figura
 * 
 * Na bazie tej klasy zdefinuj klasy konkretnych  figur geometrycznych  np. - prostokąt, koło, trójkąt a w nich odpowiednie konstruktory i metody,
 * tak  aby można było wywoływać polimorficznie metody getPole(), getObwod() i show() posługując sie odnośnikiem typu Figura.
 * 
