 ...
 *          
 *          try{Thread.sleep(delay);} //uspienie watku
 ...
 *      BasicAnim anim  = new BasicAnim(); //utworzenie panelu do rysowania
 ...
 * utworzonym przez programistę. Dla ułatwienia komunikacji klasa wątku pobocznego
 * może być klasą wewnętrzną w klasie BasicAnim.
 * 
 ...
 * paintComponent() wykreslanie nowego koła zgodnie z wątkiem drugim i wystartuj oba watki.
 * 
 * c) wprowadź następny wątek tak aby przemieszczanie się nowego koła  odbywało sie
 * tak jak na rysunku(powrót po tej samej linii) dodaj do metody paintComponent() wykreslanie
 * nowego koła zgodnie z wątkiem trzecim i wystartuj wszystkie 3 watki
 * 
