...
wszelkie zmiany w bazie danych (w tym usuwanie i tworzenie tabel) wykonujemy za pomocą metody executeUpdate aktywowanej na rzecz 
obiektu Statement
 "na tym samym" obiekcie Statement możemy wykonać dowolnie wiele poleceń SQL/DDL
od obiektu typu SQLException (wyjątku SQL) możemy się dowiedzieć wielu rzeczy np. o standardowy "SQL State" lub zależny od dostawcy 
RDBMS kod błędu.
...
Uwaga: tabela WYDAWCA jest tabelą macierzystą dla tabeli POZYCJE (klucz zewnętrzny tabeli POZYCJE odnosi się do klucza pierwotnego 
