 ...
 * przy wpisywaniu i modyfikowaniu metoda ta zwraca liczbę
 * wpisanych/zmodyfikowanych rekordów,
 * dane typu znakowego (CHAR, VARCHAR, LONGVARCHAR) są podawane w SQL
 * w apostrofach
 *
 * @version     $Id$
 */
    ...
    Zadanie11()
    {
        ...
        try {
            ...
            PreparedStatement pstmt = con
                    .prepareStatement("INSERT INTO WYDAWCA VALUES(?,?)");
