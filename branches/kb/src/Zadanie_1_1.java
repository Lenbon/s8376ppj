 ...
 * 
 * Liczby podawane są przez użytkownika, a program wypisuje wyniki obliczeń w postaci:
 * SUMA = ...
 * ILOCZYN = ...
 * ILORAZ = ...
 * MAX = ....
...
public class Zadanie_1_1 {
	public static void main(String[] args) {
		...
		System.out.println("SUMA = " + first + " + " + second + " = " + (first + second));
		System.out.println("ILOCZYN = " + first + " * " + second + " = " + (first * second));
		System.out.println("ILORAZ = " + first + " / " + second + " = " + (second != 0 ? ((double) first / (double) second) : "ERROR"));
