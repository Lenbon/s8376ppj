...
public class Zadanie33 {
	public static void main(String[] args) {
		...
		result += "podłańcuch od 3 znaku do ostatniego znaku: " + input.substring(3, input.length()) + "\n";
		result += "podłańcuch od 3 znaku do przedostatniego znaku: " + input.substring(3, input.length() - 1) + "\n"; 
