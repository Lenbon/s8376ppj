 ...
 * 
 * Po wykonaniu zadania 2 usunąć metodę zakupyDemo(...) z klasy Sklep, a zamiast niej zdefiniować metodę void zakupy(...), tak by następujący kod:
 * 
 * class Sklep  {
 *     private Kasa kasa;
 *     Sklep() {
