 ...
 * Na program składa się m.in. wątek generowania danych, który losowo pobiera z tablicy krajów nazwę kraju, z tablicy dat - datę, a z tablicy temperatur dwie liczby: temperaturę w dzien i w nocy.
 * Z tych danych formuje "rekord": kraj data temp_w_dzien temp_w_nocy.
 * 
 * Dla każdego kraju działa  wątek odbioru danych, który od wątku-generatora otrzymuje  kolejne rekordy dla danego kraju i zapisuje je do pliku o nazwie: nazwa_kraju.temp w postaci  binarnej.
 * 
