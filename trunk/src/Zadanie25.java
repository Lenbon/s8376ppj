...
public class Zadanie25 {
	public static void main(String[] args) {
		...
		System.out.println("To jest koło nr." + c1.dajNr() + " z ilości " + Circle.dajIlosc());
		
		Circle c2 = new Circle(new Point(2, 2), 5);
		System.out.println("To jest koło nr." + c2.dajNr() + " z ilości " + Circle.dajIlosc());
		
		Circle c3 = new Circle(new Point(3, 3), 5);
		System.out.println("To jest koło nr." + c3.dajNr() + " z ilości " + Circle.dajIlosc());
		
		Circle c4 = new Circle(new Point(4, 4), 5);
		System.out.println("To jest koło nr." + c4.dajNr() + " z ilości " + Circle.dajIlosc());
		
		Circle c5 = new Circle(new Point(5, 5), 5);
		System.out.println("To jest koło nr." + c5.dajNr() + " z ilości " + Circle.dajIlosc());
